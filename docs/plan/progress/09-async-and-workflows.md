...
- Active/next checklist group: 09.1, after prerequisites are satisfied.
...
| 09.3 | Implement durable workflow and retention foundations | Not started | None yet |
...
2. Start the first unfinished item in 09.1.
