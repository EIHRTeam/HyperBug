...
- Active/next checklist group: 02.1, after prerequisites are satisfied.
...
| --- | --- | --- | --- |
| 02.1 | Specify the domain and protocol | Not started | None yet |
| 02.2 | Implement persistence contracts and migrations | Not started | None yet |
| 02.3 | Establish reusable compatibility tests | Not started | None yet |
...
2. Start the first unfinished item in 02.1.
3. Record the actual files changed, checks run, decisions, and next-session cautions here.

## Next-session cautions

D1 batches and PostgreSQL interactive transactions have different capabilities. Prove atomic business outcomes rather than pretending their APIs are interchangeable.
