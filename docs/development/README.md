...
The stable Elysia lane is required. A separate next lane is deferred until the stable foundation passes; the currently published next is a different major (2.0 beta), so updating it in a required lane would violate the chosen baseline.
