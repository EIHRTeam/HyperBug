/* eslint-disable */
// Generated by Wrangler by running `wrangler types --config=apps/api-cloudflare/wrangler.jsonc apps/api-cloudflare/worker-configuration.d.ts` (hash: 197ec4ecacf297a970778b44f1abd5d3)
// Runtime types generated with workerd@1.20260916.1 2026-09-16 enable_request_signal,nodejs_compat
interface __BaseEnv_Env {
	HYPERBUG_ENV: "staging" | "production" | "local";
	DB?: D1Database;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "HYPERBUG_ENV" | "ALLOWED_ORIGINS">> {}
}
